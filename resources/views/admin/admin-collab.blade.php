...
<body>
    <div class="container-scroller">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Company Collaboration</h3>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{ asset('storage/' . $collab->collab_company) }}" alt="" style="width: 80px; height: 80px; border-radius: 6px;"></td>
                                                            <td>{{$collab->collab_company_name}}</td>
                                                            <td><a href="" class="text-success" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myEditModal{{$collab->id}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                            <td><a href="" class="text-danger" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myDeleteModal{{$collab->id}}"><i class="fa-solid fa-trash-can"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        <h4 class="modal-title">Add Collab Company</h4>
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                    </div>


                    <div class="modal-body">
                        <form action="{{route('addCollab')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="collab_company">Image</label>
                                <input type="file" class="form-control" id="collab_company" name="collab_company">
                                <small id="emailHelp" class="form-text text-muted">Upload banner less than 1.5 MB</small>
                            </div>

                            <div class="form-group">
                                <label for="collab_company_name">Title</label>
                                <input type="text" id="collab_company_name" name="collab_company_name" class="form-control">
                            </div>
        ...
        <!-- edit modal -->
        @foreach($collabs as $collab)
        <div class="modal" id="myEditModal{{$collab->id}}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('editCollab', $collab->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group" style="display: flex; justify-content: center;">
                                <img src="{{ asset('storage/' . $collab->collab_company) }}" style="width: 200px; border-radius: 10px;" alt="">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="collab_company_name">Title</label>
                                <input type="text" id="collab_company_name" name="collab_company_name" class="form-control" value="{{$collab->collab_company_name}}">
                            </div>
        ...
        <!-- delete modal -->
        @foreach($collabs as $collab)
        <div class="modal fade" id="myDeleteModal{{$collab->id}}" tabindex="-1" aria-labelledby="myDeleteModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myDeleteModal{{$collab->id}}">Confirm Delete</h5>
                    </div>
                    <div class="modal-body">
                        Are you sure you want to delete this information?
                    </div>
                    <div class="modal-footer">
                        <form action="{{route('deleteCollab', $collab->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
