...
<body>
    <div class="container-scroller">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><img src="{{ asset('storage/' . $blogData->b_img) }}" alt="" style="border-radius: 10px; width: 70px; height: 60px;"></td>
                                                            <td>{{$blogData->b_title}}</td>
                                                            <td>{{$blogData->b_message}}</td>
                                                            <td><a href="" class="text-success" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myEditModal{{$blogData->id}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                            <td><a href="" class="text-danger" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myDeleteModal{{$blogData->id}}"><i class="fa-solid fa-trash-can"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('addBlogs')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label for="b_message">Description</label>
                                <textarea class="form-control" name="b_message" id="b_message" rows="3"></textarea>
                            </div>
        ...
        <!-- edit modal -->
        @foreach($blogDatas as $blogData)
        <div class="modal" id="myEditModal{{$blogData->id}}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('editBlogs', $blogData->id) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <div class="form-group" style="display: flex; justify-content: center;">
                                <img src="{{ asset('storage/' . $blogData->b_img) }}" style="width: 230px; border-radius: 10px;" alt="">
                            </div>
                            ...
                            <div class="form-group">
                                <label for="b_title">Title</label>
                                <input type="text" id="b_title" name="b_title" class="form-control" value="{{$blogData->b_title}}">
                            </div>

                            <div class="form-group">
                                <label for="b_message">Description</label>
                                <textarea class="form-control" name="b_message" id="b_message" rows="3">{{$blogData->b_message}}</textarea>
                            </div>
        ...
        <!-- delete modal -->
        @foreach($blogDatas as $blogData)
        <div class="modal fade" id="myDeleteModal{{$blogData->id}}" tabindex="-1" aria-labelledby="myDeleteModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myDeleteModal{{$blogData->id}}">Confirm Delete</h5>
                    </div>
                    <div class="modal-body">
                        Are you sure you want to delete this information?
                    </div>
                    <div class="modal-footer">
                        <form action="{{route('deleteBlogs', $blogData->id) }}" method="POST">
                            @csrf
                            @method('DELETE')
