...
<head>
    ...
    <title>Gallery | Bending Job Work</title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
                        ...
                        <div class="col-md-12 grid-margin">
                            <div class="row">
                                <div class="col-12 col-xl-8 mb-4 mb-xl-0">
                                    <h3 class="font-weight-bold">Bending Gallery</h3>
                                </div>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-hover">
                                                    ...
                                                    <tbody>
                                                        @foreach($gbs as $gb)
                                                        <tr>
                                                            <td><img src="{{ asset('storage/' . $gb->g_bending) }}" alt="" style="width: 80px; height: 80px; border-radius: 6px;"></td>
                                                            <td>{{$gb->g_b_title}}</td>
                                                            <td><a href="" class="text-success" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myEditModal{{$gb->id}}"><i class="fa-solid fa-pen-to-square"></i></a></td>
                                                            <td><a href="" class="text-danger" style="font-size: 1.4rem;" data-toggle="modal" data-target="#myDeleteModal{{$gb->id}}"><i class="fa-solid fa-trash-can"></i></a></td>
                                                        </tr>
                                                        @endforeach
                                                    </tbody>
                                                </table>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('addGB')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label for="g_bending">Image</label>
                                <input type="file" class="form-control" id="g_bending" name="g_bending">
                                <small id="emailHelp" class="form-text text-muted">Upload banner less than 1.5 MB</small>
                            </div>

                            <div class="form-group">
                                <label for="g_b_title">Title</label>
                                <input type="text" id="g_b_title" name="g_b_title" class="form-control">
                            </div>
        ...
        <!-- edit modal -->
        @foreach($gbs as $gb)
        <div class="modal" id="myEditModal{{$gb->id}}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="{{route('editGB', $gb->id)}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group" style="display: flex; justify-content: center;">
                                <img src="{{ asset('storage/' . $gb->g_bending) }}" style="width: 200px; border-radius: 10px;" alt="">
                            </div>
                            <div class="form-group">
                                <label for="g_bending">Image</label>
                                <input type="file" class="form-control" id="g_bending" name="g_bending">
                            ...
                            <div class="form-group">
                                <label for="g_b_title">Title</label>
                                <input type="text" id="g_b_title" name="g_b_title" class="form-control" value="{{$gb->g_b_title}}">
                            </div>
        ...
        <!-- delete modal -->
        @foreach($gbs as $gb)
        <div class="modal fade" id="myDeleteModal{{$gb->id}}" tabindex="-1" aria-labelledby="myDeleteModal" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="myDeleteModal{{$gb->id}}">Confirm Delete</h5>
                    </div>
                    <div class="modal-body">
                        Are you sure you want to delete this information?
                    </div>
                    <div class="modal-footer">
                        <form action="{{route('deleteGB', $gb->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
